...
import { getEmployee ,deleteEmployee } from "../store/employeeSlice";
...
export default function Employee() {
  ...
  //الهووكس قدمت فانكشين جاهزة بتعمل وصول وبتجيب الحالة 
            const {emplyees, isLoding , error }= useSelector((state)=>state.emplyees);
            ...
            const StyledTableRow = styled(TableRow)(({ theme }) => ({
              ...
              >
                <TableHead>
                  ...
                  < NavLink to="AddEmp" style={{  textDecoration: 'none' }} >Add Employee  </NavLink>
                  </Button>
          ...
          {item.phone}
            ...
            onClick={()=>dispatch(deleteEmployee(item.employeeId))} 
            >Delete</Button>
